...
import { CARD_TYPE_LABELS, PARSE_STAGE_LABELS, REVISION_FIELD_LABELS, typeLabels, statusLabels } from './constants/labels';
import {
  knownViews,
...
import { SUBTYPE_TO_VARIANT, CREATE_KB_KITS, kitCards } from './constants/artifact';
import {
  materialFromApi,
  materialPreview,
  materialSourceUrl,
  ...
  canParseMaterial,
  formatMaterialTime,
  buildParseTimelineStages,
  splitBatchCaptureInput,
} from './utils/material';
import { formatPercent, safeFilename, formatRevisionTime } from './utils/format';
import {
  artifactMarkdown,
...
function ArtifactView({ artifact, detail, setView, artifactOrigin, onClearOrigin, onArtifactUpdate }) {
