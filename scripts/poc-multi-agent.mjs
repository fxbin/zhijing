...
assert(RESEARCH_AGENT_PROMPT.includes('结果沉淀协议'), 'research 提示词包含结果沉淀协议');
assert(RESEARCH_AGENT_PROMPT.includes('proposal-batch'), 'research 提示词要求通过 proposal-batch 沉淀');
...
assert(ROUNDTABLE_AGENT_PROMPT.includes('结果沉淀协议'), 'roundtable 提示词包含结果沉淀协议');
assert(ROUNDTABLE_AGENT_PROMPT.includes('proposal-batch'), 'roundtable 提示词要求通过 proposal-batch 沉淀');
